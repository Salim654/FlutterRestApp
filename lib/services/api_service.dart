...
class ApiService {
  final Uri apiUrl = Uri.parse('http://127.0.0.1:3000/cases');
  ...
  Future<Cases> getCaseById(String id) async {
    final response = await get(Uri.parse('http://127.0.0.1:3000/cases/$id'));
  ...
  Future<Cases> updateCases(String id, Cases cases) async {
    ...
    final Response response = await put(
     // '$apiUrl/$id' as Uri,
     Uri.parse('http://127.0.0.1:3000/cases/$id'),
  ...
  Future<void> deleteCase(String id) async {
    Response res = await delete(Uri.parse('http://127.0.0.1:3000/cases/$id'));
